...
<div class="main-card ">
  <?php foreach ($tests as $test) : ?>
    ...
    <div class="card">
      ...
      <div class="card-header-1 " style="padding-top: 12vh;padding-bottom:10vh">
        <h5><b>Name :</b><?= $test['name'] ?> </h5>

        <h5><b>Fee :</b><?= $test['fee'] ?> </h5>
      </div>

      <div style="align-content:center">
        <?php echo $component->button('edit-details', '', 'Edit Details', 'button--class-0 ', $test['name']) ?>
      </div>
      <div style="align-content:center">
...
<?php foreach ($tests as $test) : ?>
  ...
  <div class="detail-container">
    ...
    <div class="button-0" style="margin-left: 35%;" id=<?= $test['name'] ?>>
      <?php echo $component->button('edit-details', '', 'Delete', 'button--class-00  width-10', 'edit-details'); ?>
    </div>

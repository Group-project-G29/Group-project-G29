...
<section class="summary-report">
    ...
    <div class="lower-info-container">
        ...
        <canvas id='myChart-patient' class="fix-width"></canvas>
            <?=$chartModel->lineChart($patientchart['labels'],[],$patientchart['values'],[],'Patient Visit Statistics','lightblue','-patient');?>
        </div>
        <div class="lower-box">
            <h2>Income in Last 12 Months</h2>
              <canvas id='myChart-income' class="fix-width"></canvas>
            <?=$chartModel->lineChart($incomechart['labels'],[],$incomechart['values'],[],'Income Statistics','lightblue','-income');?>
        </div>
    </div>

...
<div class="semi-header-container" style="left: 20vw;padding-top:0vw;">
  ...
  <div class="field-container" style="margin-left: 5vw; line-height:1.5vw">
    ...
    <h4><b> Test Name : </b><?= $patients[0]['tname'] ?></h4>
      <h4 style="color:red"><b>*Note : </b><?= $patients[0]['note'] ?></h4>
    </div>
  </div>
  ...
  <div class="field-container" style="margin-left: 5vw;">
    ...
    <?php endforeach ?>
    <?php else:?>
      <?php foreach ($imageReport as $img) : ?>
      
      <div class="report-container" style="width:140%">
       
      <label for="image"> </label><br>
            <input type='file' name="location" value=<?="'". $img['location']."'"?>><br>
        <br>
      </div>
    <?php endforeach ?>
    <?php endif;?>

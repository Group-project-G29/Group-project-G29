    ...
    <?php if($orders): ?>
        ...
        <?php foreach($orders as $key=>$order): ?>
            ...
            <!-- <div class="popup confirmation" id="popup_confirmation">
                    ...
                    <h2>Are You Sure ? <?=$order['order_ID']?></h2>
                    <div>
                        <div><button type="button" onclick="closePopup_confirmation()" id="ok_confirmation">CANCLE</button></div>
                        <div><button type="button" onclick="closePopup_confirmation()" id="cancle_confirmation">OK</button></div>
                    </div>
            </div> -->
            ...
            <?php elseif($order['processing_status']=='waiting'): ?> 
                        ...
                        <td><?=$order['contact']?></td> 
                        <td><?=$order['created_date']?></td> 
                        <td><a class='delete-order' id=<?=$order['order_ID']?> onclick="openPopup_confirmation()">Delete Order</a></td>
                    </tr>
...
<!-- ========================POPUP====================== -->
    ...
    <div class="popup confirmation" id="popup_confirmation">
            <h2>Delete this order. <?=$order['order_ID']?></h2>
            <h2>Are You Sure ?</h2>
            <div>
                <div><button type="button" onclick="closePopup_confirmation()" id="ok_confirmation">CANCLE</button></div>
                <div><button type="button" onclick="closePopup_confirmation()" id="cancle_confirmation">OK</button></div>
...
<!-- <?php if(isset($popup)): ?> 
    ...
    <!-- <div class="popup open-popup" id="popup">
            <h2>Successful !!</h2>
            <p> Notification has been sent.. </p>
            <button type="button" onclick="closePopup_notify_medicine()" id="ok">OK</button>
    </div> -->
    <!-- <?php endif; ?>
<?php endif; ?> -->

...
$form=Form::begin('/ctest/update-my-details?cmd=update&id='.Application::$app->session->get('userObject')->emp_ID,'post');?> 

<section class="update-form-body">
    ...
    <div class="btn-div"><?php echo $component->button("update-personalDetails","submit","Save","button--class-0","update-personalDetails")?></div>

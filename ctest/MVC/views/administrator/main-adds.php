...
<div class="table-container">
    <table border="0">
        ...
        <?php foreach($advertisements as $key=>$advertisement): 
            if($advertisement['type']=="pharmacy"){
                $path = "./media/images/advertisements/pharmacy/";
            }
            else if($advertisement['type']=="lab"){
                $path = "./media/images/advertisements/lab/";
            }
            else{
        ...
        <tr class="table-row" style="width: 95vw;">
            <td><img src=<?=$path.$advertisement["img"] ?> alt="Loading image" style="height: 250px; width: 300px;" ></td>

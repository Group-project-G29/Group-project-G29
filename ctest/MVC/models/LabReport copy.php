...
use app\core\PDF;
    ...
    class LabReport extends DbModel{
        ...
        public function get_report_patient($report_ID){
            return $this->customFetchAll("select lab_request.patient_ID from lab_report left join lab_request on lab_request.request_ID=lab_report.request_ID  where lab_report.report_ID=".$report_ID)[0]['patient_ID'];
        }

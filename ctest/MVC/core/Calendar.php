...
class Calendar{
  public array $months=['1'=>31,'2'=>28,'2L'=>29,'3'=>31,'4'=>30,'5'=>31,'6'=>30,'7'=>31,'8'=>31,'9'=>30,'10'=>31,'11'=>30,'12'=>31];
    ...
    public function findDateByDay($startdate,$startday,$findday,$same=false){
      ...
      $year=$date->get($startdate,'year');
        ...
        if($add_days>$this->months[$month]){
            ...
            return [(string)($add_days-$this->months[$month]),(string)($month+1),(string)$year];
            
        }
        else{
          
          return [(string)$add_days,(string)$month,(string)$year];
        }

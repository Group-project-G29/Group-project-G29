...
class SummaryReportsPayment{
    ...
    public function paymentReport(){
        ...
        $orderCount = $parmacyIncome[0]['COUNT(payment.payment_status)'];
        $orderIncome = $parmacyIncome[0]['SUM(amount)'];
        $str2.="<tr><td>$orderCount</td><td>LKR ".number_format($orderIncome,2,'.','')."</td><tr>";

        $labCount = $laboratoryIncome[0]['COUNT(payment.payment_status)'];
        $labIncome = $laboratoryIncome[0]['SUM(amount)'];
        ...
        <body>
                ...
                <span>
                    ...
                    <div>
                        <table border='0'>
                            <tr><th>Doctor Name</th><th>Patient Count</th><th>Doctor Income</th><th>Center Income</th></tr>
                            ".$str1."
                        </tabel>
                    </div>
                    ...
                    <div>
                        <table border='0'>
                            <tr><th>Doctor Income</th><th>Orders Income</th><th>Lab Income</th><th>Center Income</th><th>Total Income</th></tr>
                            ".$str4."
                        </tabel>
                    </div>

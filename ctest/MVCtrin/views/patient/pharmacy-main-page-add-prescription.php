     ...
     <div class="ph-main-services">
        <div class="pharmacy-main-page--upload-prescription">
            <div class="service-content--1">
                ...
                <?= $component->button('upload-precription','',"Upload Prescription","button-class--yellow",'upload_pres'); ?>
            </div>
        </div>
...
<script>
    const bg=document.querySelector(".bg");
        ...
        const uploadPresBtn=e('upload_pres');
        const popUp=e('.prescription-popup','class');
        uploadPresBtn.addEventListener('click',()=>{
